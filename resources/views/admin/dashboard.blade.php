...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link pomeroy" href="{{ route('categories') }}">Categories</a></li>
    ...
    <div class="container mt-5">
        ...
        <p>Use the navigation bar to manage Items, Categories, Suppliers, and view stock reports.</p>
    </div>
